...
namespace BankTransferSample
{
    public class BasicTest
    {
        ...
        public static void Run()
        {
            ...
            //账户1向账户2转账300元
            Signal = new ManualResetEvent(false);
            commandService.Send(new CreateTransaction(new TransactionInfo(Guid.NewGuid(), "00001", "00002", 300D)));
            Signal.WaitOne();
            ...
            //账户2向账户1转账500元
            Signal = new ManualResetEvent(false);
            commandService.Send(new CreateTransaction(new TransactionInfo(Guid.NewGuid(), "00002", "00001", 500D)));
            Signal.WaitOne();
    ...
    //[Component]
    //public class BasicTestSyncService :
