...
namespace ENode.Eventing.Impl
{
    ...
    /// </summary>
    public class DefaultUncommittedEventProcessor : MessageProcessor<IUncommittedEventQueue, IUncommittedEventMessageHandler, EventStream>, IUncommittedEventProcessor
    {
