...
namespace NetSerializer
{
	public static class Primitives
	{
        ...
        /// <summary>
        /// 写System.Decimal类型，魏琼东 2013/05/10
        /// </summary>
        /// <param name="stream"></param>
        /// <param name="value"></param>
        public static void WritePrimitive(Stream stream, System.Decimal value)
        {
            int [] nums = decimal.GetBits(value);
            byte[] buffer = new byte[16];
            for (int i = 0; i < nums.Length; i++)
            {
                byte[] bytes = BitConverter.GetBytes(nums[i]);
                Buffer.BlockCopy(bytes, 0, buffer, i * 4, bytes.Length);
            }
        ...
        /// <summary>
        /// 读System.Decimal类型，魏琼东 2013/05/10
        /// </summary>
        /// <param name="stream"></param>
        /// <param name="value"></param>
        public static void ReadPrimitive(Stream stream, out System.Decimal value)
        {
            byte[] buffer = new byte[16];
            ...
            for (int i = 0; i < nums.Length; i++)
            {
                nums[i] = BitConverter.ToInt32(buffer, 0 * 4);
            }

            value = new decimal(nums);
        }

        #endregion

        #region System.IntPtr/UIntPtr
        ...
        /// <param name="stream"></param>
        /// <param name="value"></param>
        public static void WritePrimitive(Stream stream, System.IntPtr value)
        {
            WriteVarint64(stream, EncodeZigZag64(value.ToInt64()));
        }
        ...
        /// <param name="stream"></param>
        /// <param name="value"></param>
        public static void WritePrimitive(Stream stream, System.UIntPtr value)
        {
            WriteVarint64(stream, value.ToUInt64());
        }
        ...
        /// <param name="stream"></param>
        /// <param name="value"></param>
        public static void ReadPrimitive(Stream stream, out System.IntPtr value)
        {
            long value2 = 0;
            value2 = DecodeZigZag64(ReadVarint64(stream));
            value = new IntPtr(value2);
        }

        public static void ReadPrimitive(Stream stream, out System.UIntPtr value)
        {
            value = new UIntPtr(ReadVarint64(stream));
        }
